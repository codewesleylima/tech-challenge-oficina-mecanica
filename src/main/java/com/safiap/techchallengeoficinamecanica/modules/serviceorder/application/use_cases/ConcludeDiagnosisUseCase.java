...
import com.safiap.techchallengeoficinamecanica.modules.serviceorder.application.commands.ConcludeDiagnosisCommand;
...
@Service
public class ConcludeDiagnosisUseCase {

    private final ServiceOrderRepository serviceOrderRepository;
    private final DomainEventPublisher eventPublisher;

    public ConcludeDiagnosisUseCase(ServiceOrderRepository serviceOrderRepository, DomainEventPublisher eventPublisher) {
        this.serviceOrderRepository = serviceOrderRepository;
        this.eventPublisher = eventPublisher;
    }

    @Transactional
    public ServiceOrderResponse execute(ConcludeDiagnosisCommand command) {
        ...
        serviceOrder.concludeDiagnosis(command.notes());
