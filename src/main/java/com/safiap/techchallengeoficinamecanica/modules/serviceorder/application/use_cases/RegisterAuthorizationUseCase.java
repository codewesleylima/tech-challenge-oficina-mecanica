...
import com.safiap.techchallengeoficinamecanica.modules.serviceorder.application.commands.RegisterAuthorizationCommand;
...
@Service
public class RegisterAuthorizationUseCase {

    private final ServiceOrderRepository serviceOrderRepository;
    private final DomainEventPublisher eventPublisher;

    public RegisterAuthorizationUseCase(ServiceOrderRepository serviceOrderRepository, DomainEventPublisher eventPublisher) {
        this.serviceOrderRepository = serviceOrderRepository;
        this.eventPublisher = eventPublisher;
    }

    @Transactional
    public ServiceOrderResponse execute(RegisterAuthorizationCommand command) {
        ...
        serviceOrder.registerAuthorization(command.notes());
