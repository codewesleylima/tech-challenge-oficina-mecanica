...
import com.safiap.techchallengeoficinamecanica.modules.serviceorder.application.commands.CancelServiceOrderCommand;
...
public class CancelServiceOrderUseCase {
    ...
    public CancelServiceOrderUseCase(ServiceOrderRepository serviceOrderRepository, DomainEventPublisher eventPublisher) {
        this.serviceOrderRepository = serviceOrderRepository;
        this.eventPublisher = eventPublisher;
    }

    @Transactional
    public ServiceOrderResponse execute(CancelServiceOrderCommand command) {
