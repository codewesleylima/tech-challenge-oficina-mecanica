...
public record ServiceOrderAuthorizedEvent(UUID serviceOrderId, Instant occurredOn) implements DomainEvent {
    public ServiceOrderAuthorizedEvent(UUID serviceOrderId) {
