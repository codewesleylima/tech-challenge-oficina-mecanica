...
import com.safiap.techchallengeoficinamecanica.modules.serviceorder.application.commands.ConcludeServiceOrderCommand;
...
@Service
public class ConcludeServiceOrderUseCase {

    private final ServiceOrderRepository serviceOrderRepository;
    private final DomainEventPublisher eventPublisher;

    public ConcludeServiceOrderUseCase(ServiceOrderRepository serviceOrderRepository, DomainEventPublisher eventPublisher) {
        this.serviceOrderRepository = serviceOrderRepository;
        this.eventPublisher = eventPublisher;
    }

    @Transactional
    public ServiceOrderResponse execute(ConcludeServiceOrderCommand command) {
